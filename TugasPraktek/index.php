...
?>
	...
	<a href="logout.php" class="btn btn"><i class="fa fa-lock"></i> Logout</a>
	<button class="btn btn-success" type="button" data-toggle="modal" data-target="#myModal">
  <i class="fa fa-plus"></i> Tambahkan Siswa Baru
  </button>
  <hr>
...
<input type="text" class="form-control" name="card_no" placeholder="Tuliskan NIM." maxlength="12" required>
</div>
<div class="form-group col-md-6">
<label for="inputPassword4">No.Handphone</label>
<input type="phone" class="form-control" name="user_phone" placeholder="Tuliskan No-tlp" maxlength="10" required>
</div>
</div>
...
<input type="text" class="form-control" name="user_first_name" placeholder="Tuliskan Nama Depan">
</div>
<div class="form-group col-md-6">
<label for="lastname">Nama Belakang</label>
<input type="text" class="form-control" name="user_last_name" placeholder="Tuliskan Nama Belakang">
</div>
</div>
...
<input type="text" class="form-control" name="user_father" placeholder="Tuliskan Nama Ayah">
</div>
<div class="form-group col-md-6">
<label for="mothername">Nama Ibu</label>
<input type="text" class="form-control" name="user_mother" placeholder="Tuliskan Nama Ibu">
</div>
</div>
...
<input type="email" class="form-control" name="user_email" placeholder="Tuliskan Alamat Email Anda">
</div>
<div class="form-group col-md-6">
<label for="aadharno">NIK</label>
<input type="text" class="form-control" name="user_NIK" maxlength="12" placeholder="Tuliskan No NIK ">
</div>
</div>
...
<input type="text" class="form-control" name="village" placeholder="Tuliskan Alamat">
</div>
<div class="form-group">
...
<input type="text" class="form-control" name="staff_id" maxlength="13" placeholder="Tuliskan 13 Angka">
</div>
